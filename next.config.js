...
const ContentSecurityPolicy = `
  default-src 'self';
  connect-src https://api-adresse.data.gouv.fr ${process.env.NEXT_PUBLIC_APP_BASE_URL} ${process.env.NEXT_PUBLIC_API_BASE_URL} ${process.env.NEXT_PUBLIC_API_BASE_URL};
