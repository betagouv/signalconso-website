...
const ContentSecurityPolicy = [
  ...
  `connect-src 'self' *.sentry.io *.data.gouv.fr *.beta.gouv.fr ${process.env.NEXT_PUBLIC_API_BASE_URL} ${process.env.NEXT_PUBLIC_COMPANY_API_BASE_URL} ${process.env.NEXT_PUBLIC_SIRET_EXTRACTOR_BASE_URL};`,
  ...
  `frame-src *.data.gouv.fr/ *.beta.gouv.fr *.twitter.com https://www.youtube-nocookie.com https://app-2361543a-545f-4c8e-88f5-89f57aaffc78.cleverapps.io/;`,
