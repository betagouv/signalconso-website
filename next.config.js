...
const ContentSecurityPolicy = [
  ...
  `connect-src 'self' *.sentry.io *.data.gouv.fr *.beta.gouv.fr ressources.data.sncf.com ${process.env.NEXT_PUBLIC_API_BASE_URL} ${process.env.NEXT_PUBLIC_COMPANY_API_BASE_URL} ${process.env.NEXT_PUBLIC_SIRET_EXTRACTOR_BASE_URL};`,
