...
export type SpecificWebsiteCompanyKind = Extract<
  CompanyKind,
  "MERCHANT_WEBSITE" | "TRANSPORTER_WEBSITE"
>;
export type SpecificProductCompanyKind = Extract<
  CompanyKind,
  "PRODUCT" | "PRODUCT_POINT_OF_SALE"
>;
...
export const allowedInputTypesInYaml = Object.values(DetailInputType).filter(
  (_) => _ !== DetailInputType.TEXTAREA
);
