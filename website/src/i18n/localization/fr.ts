...
export const fr = {
  ...
  messages: {
    titleAndDescriptions: {
      ...
      litige: {
        title: 'Vos démarches à conduire en parallèle - SignalConso',
        description: `Nos conseils pour résoudre un litige avec une entreprise : courrier, médiation, et attaque en justice`,
      },
      litigeTelecom: {
    ...
    footer: {
      ...
      litigeLinkTitle: 'Démarches à conduire en parallèle de SignalConso',
    ...
    TrainDescription: {
      ...
      TGV_LYRIA: '',
      TGV_ITALIE: 'y compris TGV INOUI Italie',
      TRENITALIA: '',
      RENFE: '',
      ICE: '',
      TRAIN_DE_NUIT: '',
    ...
    attachmentsDesc2: `Ajouter une pièce jointe augmente <strong>FORTEMENT</strong> vos chances d’entraîner une mesure corrective&nbsp;!<br/>Exemples : un contrat, une facture, des échanges avec le SAV…<br/><br/>Vous ne devez pas communiquer de données sensibles (données bancaires ou médicales).`,
    notTransmittableAttachmentsDesc2: `Ajoutez une pièce jointe (par exemple : un contrat, une facture, des échanges avec le SAV…) pour aider la répression des fraudes.<br/> Vous ne devez pas communiquer de données sensibles (données bancaires ou médicales).`,
    ...
    identifyBy_identity: `Par son numéro SIRET, SIREN, ou TVA intracommunautaire`,
...
contacter directement.`,
    ...
    yourPostalCodePlaceholder: `Ex : toulon, 44000`,
    geoAreaPlaceholder: `Ex : toulon, 44000, haute garonne, ...`,
    ...
    contactAgreementTrueDesc: `mes coordonnées et mon numéro de référence avec l'entreprise afin qu'elle puisse me contacter dans le cadre de mon signalement (<b>uniquement</b>).`,
    contactAgreementFalseTitle: `Je ne partage pas`,
    contactAgreementFalseDesc: `mes coordonnées et mon numéro de référence avec l'entreprise. Seule la répression des fraudes y aura accès. <br/><strong>Je n'aurais pas de solution ou de réponse personnalisée.</strong>`,
    ...
    confirmationModalText: "Vous avez choisi de rester anonyme. Le signalement (hors coordonnées) sera envoyé au professionnel. Veillez à ce qu’aucun élément ne permette de vous identifier dans la description ou les pièces jointes.",
    ...
    didTheCompanyHonouredItsCommitment: `L'entreprise a-t-elle tenu son engagement ?`,
    ...
    iAmHappyAboutCommitment: `Oui, elle a tenu son engagement !`,
    iAmNeutralAboutCommitment: `Je dirais qu'elle a tenu en partie son engagement`,
    iAmUnhappyAboutCommitment: `Malheureusement non, elle n'a pas tenu son engagement.`,
    send: `Envoyer`,
