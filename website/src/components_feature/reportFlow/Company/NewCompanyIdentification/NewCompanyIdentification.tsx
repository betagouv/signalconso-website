...
export function NewCompanyIdentification({
  ...
  const [iCantFind, setICantFind] = useState(false)
    ...
    <div>
      ...
      {iCantFind && (
        <FriendlyHelpText>
          ...
          <p>
            Si vraiment vous ne pouvez pas identifier l'entreprise, vous pouvez continuer quand même votre signalement. Il sera
            communiqué aux agents de la répression des fraudes, qui feront de leur mieux pour traiter votre signalement. Mais les
            chances de succès diminuent grandement.
          </p>
          <div className="flex gap-4 justify-between">
            <Button priority="secondary" iconId="ri-arrow-left-line" onClick={() => setICantFind(false)}>
