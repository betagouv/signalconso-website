...
/!\ J'ai aussi un problème de permission à un moment, je n'avais pas la permission de lancer des scripts, une histoire de "policy" je crois. J'ai tapé le message d'erreur et j'ai trouvé directement sur stackoverflow une commande pour me donner les bonnes permissions.

Penser à montrer à Guillaume le Ctrl+C pour stopper la commande en cours.
...
J'ai aussi l'impression que les variables d'environnements ne sont pas  bien passées au site. Mais il ne devrait pas en avoir besoin pour travailler sur le YAML.
