export function ForeignVisitorsQaPromoBanner() {
  return (
    <div className="mt-6 py-4 px-4 mx-auto border bxorder-l-8 border-gray-500 border-solid ">
      If you have a question about tickets, flights, hotels, restaurants, transport, payments, etc. regarding your stay in France
      for the Rugby World Cup 2023 or the Paris 2024 Olympic Games, your answer might be here :{' '}
      <a
