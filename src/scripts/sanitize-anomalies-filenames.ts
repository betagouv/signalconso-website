...
// Rename all files/directories automatically (adjust names and numbers)
//
// This can be done at any time
//
// It is not mandatory, it's just so that the names reflect the actual "title"
// and so that the numbers are sequential
function sanitizeAnomaliesFilenames() {
