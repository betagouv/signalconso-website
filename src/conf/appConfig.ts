...
enum Env {
  ...
  NEXT_PUBLIC_INFO_BANNER_IS_MOBILE = 'NEXT_PUBLIC_INFO_BANNER_IS_MOBILE',
...
const persistedTempEnvVariablesForFront: {[key in Env]: string | undefined} = {
  ...
  NEXT_PUBLIC_INFO_BANNER_IS_MOBILE: process.env.NEXT_PUBLIC_INFO_BANNER_IS_MOBILE,
...
export const appConfig = {
  ...
  infoBannerIsMobile: map(bool, defaultValue(false))(Env.NEXT_PUBLIC_INFO_BANNER_IS_MOBILE),
