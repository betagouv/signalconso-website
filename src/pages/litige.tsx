    ...
    <Page size="small" className="blog">
      ...
      <AccordionPanels>
        ...
        >
          ...
          <div>
            <p>
              En consultant la page<br/>
              <a href={externalLinks.vosDroits} target="_blank" rel="noreferrer" title="Service public - vos droits (nouvelle fenêtre)">
      ...
      <Panel border sx={{mt: 2}}>
        <Alert type="info">
          ...
          <p>
            Pour bénéficier de leur aide, vous devez payer une somme, appelée « adhésion ».
            Pour connaître le prix de cette adhésion, vous pouvez les contacter directement.
            En fonction de votre situation, certaines associations peuvent baisser le prix de l'adhésion.
          </p>
          <p>
            Liste des associations de consommateurs officielles :<br/>
            <a href={externalLinks.associationConso} target="_blank" rel="noreferrer">{externalLinks.associationConso}</a>
          </p>
        </Alert>
      </Panel>
    </Page>
