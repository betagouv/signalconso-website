  ...
  return (
    <Page size="small" className="blog">
      ...
      <ul>
        ...
        <li><Link href={siteMap.suiviEtViePrivee}>Suivi d'audience et vie privée</Link></li>
        <li><Link href={siteMap.cookies}>Gestion des cookies</Link></li>
        <li><Link href={siteMap.conditionsGeneralesUtilisation}>Conditions générales d'utilisation du site SignalConso</Link></li>
        <li><Link href={siteMap.accessibilite}>Déclaration d'accessibilité</Link></li>
        <li><Link href={siteMap.planDuSite}>Plan du site</Link></li>
        ...
        <li><Link href={siteMap.contact}>Contact</Link></li>
      </ul>
      ...
      <h2>Espace pro</h2>
      <ul>
        <li><Link href={siteMap.companyActivation}>Activation de l'espace entreprise</Link></li>
        <li><Link href={siteMap.connexion}>Connexion</Link></li>
