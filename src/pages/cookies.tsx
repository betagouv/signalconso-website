  ...
  return (
    <>
      ...
      <ContentPageContainer>
        ...
        <p>
          Nous utilisons que des cookies techniques qui permettent et facilitent votre navigation. Certains sont indispensables et
          ne sauraient être supprimés sans affecter gravement l’accès au site et la navigation, d’autres auraient pour conséquence
          une navigation dégradée.
        </p>
        ...
        <ul>
          ...
          <li>
            <a href="https://privacy.microsoft.com/fr-FR/windows-10-microsoft-edge-and-privacy">Edge</a>
          </li>
          <li>
        ...
        <p>
          ...
          <a target="_blank" href="https://www.cnil.fr/fr/cookies-les-outils-pour-les-maitriser">
            le site de la CNIL
          </a>
        </p>
      </ContentPageContainer>
