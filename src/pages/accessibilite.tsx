  ...
  return (
    <Page size="small" className="blog">
      ...
      <Panel>
        <PanelBody>
          <p>
            Le ministère de l'Economie, des Finances et de la Relance s’engage à rendre son service accessible, conformément
            à l’article 47 de la loi n° 2005-102 du 11 février 2005.
          </p>
          <p>
            Cette déclaration d’accessibilité s’applique à SignalConso.
          </p>


          <h2>État de conformité</h2>
          <p>
            SignalConso est <b>partiellement conforme avec le RGAA 4.0</b>. Partiellement conforme veut dire que certaines sections du contenu ne sont pas entièrement conformes aux
            standards d'accessibilités.
          </p>


          <h2>Résultats des tests</h2>
          <p>
            L’audit de conformité réalisé par évaluation externe révèle que 78% des critères RGAA sont respectés.
          </p>
          ...
          <p>
            La validité HTML ne peut être garantie sur l'ensemble des pages néanmoins à notre connaissance cela ne provoque aucun dysfonctionnement des aides techniques.
            La reprise et la vérification de toutes les pages du site représenteraient une charge de travail disproportionnée par rapport au gain attendu.
          </p>
          <p>
            Les vidéos n'ont pas d'audio description, sous-titres ou transcription textuelle. La cellule ayant en charge la mise en ligne de ces animations n'est pas en mesure
            actuellement de fournir ces éléments pour l'ensemble de ces vidéos.
          </p>


          <h2>Établissement de cette déclaration d'accessibilité</h2>
          <p>
            Cette déclaration a été établie le 4 Septembre 2020.
          </p>

          <h3>Technologies utilisées</h3>
          <p>
            L'accessibilité de SignalConso s'appuie sur les technologies suivantes :
          </p>
          <ul>
            <li>HTML</li>
            <li>WAI-ARIA</li>
          ...
          <ol>
            ...
            <li><Link href={siteMap.connexion}>Connexion à l'espace pro</Link></li>
          ...
          <p>
            Si vous n’arrivez pas à accéder à un contenu ou à un service, vous pouvez contacter le responsable de SignalConso pour être orienté vers une alternative accessible ou
          ...
          <p>
            Cette procédure est à utiliser dans le cas suivant : vous avez signalé au responsable du site internet un défaut d’accessibilité qui vous empêche d’accéder à un contenu
            ou à un des services du portail et vous n’avez pas obtenu de réponse satisfaisante.
          </p>
          <p>
            Vous pouvez :
          </p>
