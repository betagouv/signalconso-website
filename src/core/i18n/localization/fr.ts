...
export const fr = {
  ...
  messages: {
    ...
    referenceNumberDesc:
      "Pour faciliter la réponse de l'entreprise, précisez la référence de votre dossier. Ex : numéro de billet, ou de réservation, de facture, de contrat, de client, ...",
