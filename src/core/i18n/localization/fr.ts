...
export const fr = {
  ...
  messages: {
    ...
    cantIdentifyCompany: `Comme vous ne pouvez pas identifier l'entreprise, merci d'indiquer votre adresse afin que nos services puissent tenter de rapprocher ces informations avec celles qu'auraient éventuellement déposées vos voisins, ayant été en contact avec la même entreprise que vous`,
