...
export const fr = {
  ...
  messages: {
    ...
    attachmentsDesc2: `Ajouter une pièce jointe augmente de 83 % la chance d’entraîner une mesure corrective ! Vous ne devez pas communiquer de données dites "sensibles" (données bancaires ou médicales).`,
