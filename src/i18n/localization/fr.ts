...
export const fr = {
  ...
  messages: {
    ...
    TrainDescription: {
      TGV: 'y compris en correspondance avec un TER',
      EUROSTAR: '',
      TGV_LYRIA: '',
      TGV_ITALIE: '',
      TRENITALIA: '',
    ...
    Ter: {
      AUVERGNE: 'TER AUVERGNE-RHÔNE-ALPES',
      BOURGOGNE: 'TER BOURGOGNE-FRANCHE-COMTE',
      BRETAGNE: 'TER BRETAGNE',
      CENTRE_VAL: 'TER CENTRE-VAL DE LOIRE',
      GRAND_EST: 'TER GRAND EST',
      HAUTS_DE_SEINE: 'TER HAUTS-DE-FRANCE',
      AQUITAINE: 'TER NOUVELLE AQUITAINE',
