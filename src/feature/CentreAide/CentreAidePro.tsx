      ...
      <AccordionPanels>
        <AccordionPanel title="J'ai reçu un courrier de SignalConso car mon entreprise a été signalée. Que dois-je faire ?">
          <p>
            ...
            <Link href={siteMap.connexion}>
              https://signal.conso.gouv.fr</Link>
            avec votre code d’activation de 6 chiffres inscrit dans votre courrier SignalConso et cliquez sur le
            bouton
            <BtnAdmin/>
          ...
          <p>
            Vous recevrez ensuite un email vous invitant à valider votre compte.
            Renseignez ensuite vos nom et prénom, et choisissez votre mot de passe pour activer votre espace
            professionnel.
          </p>
          <p style={{textAlign: 'center'}}>
            <iframe src="https://www.youtube-nocookie.com/embed/iQLmRZW8SIk" frameBorder="0"
          ...
          <p className="text-center">
            <iframe src="https://www.youtube-nocookie.com/embed/Zohajsmkz1I" frameBorder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen/>
          </p>
          <p className="text-center">
            <iframe src="https://www.youtube-nocookie.com/embed/up9Elzn-P7o" frameBorder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen/>
          </p>
        </AccordionPanel>
          ...
          <ul>
            <li>
              ...
              <div>
                ...
                consommateur doit répondre à une série de questions prédéfinies.
                Les réponses à toutes ces questions sont renseignées dans la catégorie "Type de signalement".
                Il s'agit d'éléments d'identification sur le type d'anomalie signalée.
              </div>
            </li>
            <li>
              <strong> Détails </strong>
              <div>
                La section "Détails" permet au consommateur de décrire le contexte dans lequel il a rencontré le
                problème, d’y ajouter des précisions et de donner la date du constat.
                C’est aussi là que vous trouverez les éventuelles pièces jointes envoyées par le consommateur.
              </div>
            </li>
            <li>
              <strong> Consommateur </strong>
              <div>
                La section Consommateur vous indique si le consommateur a souhaité vous laisser ses coordonnées afin
                d'être recontacté en direct.
                Si ce n’est pas le cas, vous pouvez tout de même lui indiquer une réponse à travers SignalConso. S'il
                a souhaité vous laisser ses coordonnées, vous pouvez le contacter directement (dans le cadre du
                signalement),
                mais n’oubliez pas de préciser cette réponse sur SignalConso pour en informer la DGCCRF.
              </div>
            </li>
          </ul>
        </AccordionPanel>
        <AccordionPanel id="les-status" title="À quoi correspondent les différents statuts du signalement ?">
          <p>
            ...
            Cette liste vous donne quelques indications sur chaque signalement sans que vous ayez besoin de les ouvrir
            : la date de dépôt du signalement, le nom du consommateur si disponible, ainsi que le statut du
            signalement. Il existe trois statuts pour le signalement :
          </p>
          <ul>
            <li><strong>Non consulté :</strong> vous n’avez pas encore consulté ce signalement - il apparaît en gras.
              Dès que vous aurez cliqué dessus, le signalement passera au statut suivant.
            </li>
            <li><strong>À répondre :</strong> vous avez consulté le signalement mais vous n’y avez pas encore répondu.
            </li>
            <li><strong>Clôturé :</strong> le signalement est clôturé - vous y avez déjà apporté une réponse ou alors
              le délai de traitement a été dépassé. (cf les relances).
            </li>
          </ul>
        ...
        <AccordionPanel title="Quelle réponse puis-je apporter ?" id="la-reponse">
          ...
          <p>
            Quel que soit le choix que vous fassiez, nous vous invitons à l’expliquer au consommateur.
            Cette réponse sera visible par la DGCCRF.
            <br/>
            Nous vous offrons aussi la possibilité d’ajouter un commentaire et des pièces jointes destinés uniquement
            à la DGCCRF
            dans le champ de saisie spécifique. Actuellement, le site ne permet pas de transmettre les pièces jointes
            au consommateur.
          </p>
          <p>
        ...
        <AccordionPanel title="Et si le courrier SignalConso arrive pendant mes congés ?">
          <p>
            ...
            attendiez la confirmation d’un collaborateur ? Pas de panique !
            Après avoir récolté les retours de nombreuses entreprises, nous avons conçu un système de relances offrant
            de la souplesse dans le traitement du signalement :
          </p>
          <ul>
            <li>
              <strong>Relance courrier :</strong> nous vous avons adressé un courrier vous indiquant qu’un signalement
              avait été déposé sur votre entreprise
              mais vous n’avez pas encore activé votre Espace Professionnel.
              <br/>Après 21 jours, nous vous adressons un nouveau courrier vous invitant à l’activer.
              Une nouvelle période de 21 jours est lancée, au terme de laquelle nous clôturons le signalement.
              Vous pourrez toujours activer votre Espace Professionnel, mais vous ne pourrez plus répondre au
              signalement.
            </li>
            <li>
              <strong>Relance mail :</strong> qu’il s’agisse d’un nouveau signalement que vous n’avez pas encore
              consulté ou d’un signalement consulté mais resté sans réponse,
              nous vous envoyons un email tous les 7 jours pendant 3 semaines pour vous inviter à faire le nécessaire.
        ...
        <AccordionPanel title="Je suis en charge du suivi des signalements de différents établissements. Comment puis-je centraliser ces signalements sur un seul compte ?">
          <p>
            ...
            tous les établissements suivis sur un même compte (fonctionnalité accessible depuis la section "Gérer mes
            entreprises" du menu en haut à gauche).
          </p>
          <p className="text-center">
            <iframe src="https://www.youtube-nocookie.com/embed/tEzRx6eU474" frameBorder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen/>
          </p>
          <p>
            ...
            <br/>
            A partir du compte SignalConso de votre siège, vous avez désormais accès d'office à tous les signalements
            de vos différents établissements qui ont le même SIREN. Ainsi depuis le compte SignalConso de votre siège,
            vous avez accès à tous les signalements de vos établissements secondaires qui ont été signalés sans devoir
            vous connecter aux différents comptes.
            Vous avez toujours la possibilité d'ajouter des entreprises à la main qui ne portent pas le même SIREN que
        ...
        <AccordionPanel
          ...
          courriel lors d'un nouveau signalement.
          <br/>
          <br/>
          Pour gérer vos notifications, rendez-vous dans "Paramètres" et cliquez sur "MODIFIER" dans "Notifications".
          Ici en cliquant sur le sélecteur, vous pouvez au choix activer ou désactiver les notifications pour chaque
          établissement.
          <br/>
          <br/>
