...
export const PlaygroundAcknowledgment = () => {
  ...
  const report = useMemo(() => {
    ...
    const reportsSwitch: { [key in AcknowledgmentCases]: () => Report } = {
      ...
      [AcknowledgmentCases.ForeignCompany]: () => ({...baseReport, employeeConsumer: false, companyAddress: {...baseReport.companyAddress, country: demoCountry}}),
      [AcknowledgmentCases.NotTransmittable]: () => ({...baseReport, employeeConsumer: false, tags: [ReportTag.ProduitDangereux]}),
      [AcknowledgmentCases.FrenchCompanyWithoutSIRET]: () => ({...baseReport, employeeConsumer: false, companySiret: undefined}),
      [AcknowledgmentCases.ContractualDisputeWithSIRET]: () => ({...baseReport, employeeConsumer: false, tags: [ReportTag.LitigeContractuel]}),
