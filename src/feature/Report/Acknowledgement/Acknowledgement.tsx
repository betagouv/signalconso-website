...
enum AcknowledgmentCases {
  EmployeeReport,
  ForeignCompany,
  FrenchCompanyWithoutSIRET,
  ContractualDisputeWithSIRET,
  NotTransmittable,
  Default,
  ReponseConso,
}
              ...
              >
                ...
                {country?.european && (
                  <p>
                    ...
                    Il vous apportera une assistance pour régler votre problème.
                    <a
                      href="https://www.europe-consommateurs.eu/fr/une-question-une-reclamation"
                      target="_blank"
  ...
  return (
    <>
      ...
      <Panel title={
        ...
        <PanelBody>
          {title && (
            <Txt size="big" bold sx={{mb: 1}}>{title}</Txt>
          )}
          {children}
