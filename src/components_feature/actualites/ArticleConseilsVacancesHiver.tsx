...
export function ArticleConseilsVacancesHiver() {
  return (
    <div>
      ...
      <h2>Lorsque vous utilisez un comparateur : vérifiez ses critères de classement</h2>
      <p>
      ...
      <h2>Vous avez un problème avec votre hébergement : consultez les conditions générales de vente</h2>
      <p>
      ...
      <h2>Vous voyagez en train, en avion ou en autocar : vous pouvez être indemnisé en cas de retard</h2>
      <p>
      ...
      <h2>Vous avez réservé un séjour mais l'agence annule : votre indemnisation dépend des circonstances</h2>
      <p>
      ...
      <h2>Vous souhaitez souscrire une assurance pour partir au ski : vérifier que vous n'êtes pas déjà couvert</h2>
      <p>
