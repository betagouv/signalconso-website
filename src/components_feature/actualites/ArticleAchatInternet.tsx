...
export function ArticleAchatInternet() {
  return (
    <div>
      ...
      <h2>Vérifiez l'identité du vendeur et sa e-réputation</h2>
      <p>
      ...
      <h2>Consultez les conditions générales de vente et les mentions légales</h2>
      <p>
      ...
      <h2>Méfiez-vous des clauses abusives</h2>
      <p>
      ...
      <h2>Préférez un site français ou européen</h2>
      <p>
      ...
      <h2>Contrôlez les caractéristiques du produit</h2>
      <p>
